...
/**
* AggregateCalls {Function} - THis function takes all the parent handling processes,
* and makes a parallel call to fire off all the http connections at one and spawn each child process simoetaneously
*
* @params {Object} userInput - An Object of act suggestion locations
*/
